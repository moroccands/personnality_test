...
أجب على جميع الأسئلة بصدق واكتشف شخصيتك المكونة من 4 أحرف وفقًا لتصنيف كارل يونج وإيزابيل بريجز مايرز. ثم استكشف المهن الأكثر ملاءمة لنوع شخصيتك ، وكذلك المؤسسات حيث يمكنك الحصول على تدريب يسمح لك بالوفاء بمهنتك.		  
</li>
          <li className="list-group-item">أجب بصدق</li>
        </ul>
        <StartBtn onClick={_onStartClick}>
          <span>لنبدأ الاختبار</span>
          <div className="icon">
